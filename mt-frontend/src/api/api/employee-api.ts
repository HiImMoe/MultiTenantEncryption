...
export const EmployeeApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    employeeControllerCreateEmployee: async (
     ...
     * @throws {RequiredError}
     */
    employeeControllerGetEmployeeDetails: async (
      employeeId: string,
      options: AxiosRequestConfig = {},
    ): Promise<RequestArgs> => {
      // verify required parameter 'employeeId' is not null or undefined
      assertParamExists(
        'employeeControllerGetEmployeeDetails',
        'employeeId',
        employeeId,
      );
      const localVarPath = `/employee/{employeeId}`.replace(
        `{${'employeeId'}}`,
     ...
     * @throws {RequiredError}
     */
    employeeControllerGetEmployees: async (
      page?: number,
      pageSize?: number,
     ...
     * @throws {RequiredError}
     */
    employeeControllerUpdateEmployee: async (
      employeeId: string,
...
export const EmployeeApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async employeeControllerCreateEmployee(
      createEmployeeDTO: CreateEmployeeDTO,
      options?: AxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.employeeControllerCreateEmployee(
          createEmployeeDTO,
          options,
        );
     ...
     * @throws {RequiredError}
     */
    async employeeControllerGetEmployeeDetails(
      employeeId: string,
      options?: AxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.employeeControllerGetEmployeeDetails(
          employeeId,
          options,
        );
      return createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async employeeControllerGetEmployees(
      page?: number,
      pageSize?: number,
      employeeNumber?: string,
      gender?: string,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.employeeControllerGetEmployees(
          page,
          pageSize,
          employeeNumber,
          gender,
     ...
     * @throws {RequiredError}
     */
    async employeeControllerUpdateEmployee(
      employeeId: string,
      updateEmployeeDTO: UpdateEmployeeDTO,
      options?: AxiosRequestConfig,
    ): Promise<
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.employeeControllerUpdateEmployee(
          employeeId,
          updateEmployeeDTO,
          options,
        );
...
export const EmployeeApiFactory = function (
  ...
  return {
    ...
    employeeControllerCreateEmployee(
      ...
      return localVarFp
        .employeeControllerCreateEmployee(createEmployeeDTO, options)
    ...
    employeeControllerGetEmployeeDetails(
      ...
      return localVarFp
        .employeeControllerGetEmployeeDetails(employeeId, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    employeeControllerGetEmployees(
      page?: number,
      pageSize?: number,
      employeeNumber?: string,
      gender?: string,
...
export class EmployeeApi extends BaseAPI {
   ...
   */
  public employeeControllerCreateEmployee(
    requestParameters: EmployeeApiEmployeeControllerCreateEmployeeRequest,
    options?: AxiosRequestConfig,
  ) {
    return EmployeeApiFp(this.configuration)
      .employeeControllerCreateEmployee(
        requestParameters.createEmployeeDTO,
        options,
      )
   ...
   * @memberof EmployeeApi
   */
  public employeeControllerGetEmployeeDetails(
    requestParameters: EmployeeApiEmployeeControllerGetEmployeeDetailsRequest,
    options?: AxiosRequestConfig,
  ) {
    return EmployeeApiFp(this.configuration)
      .employeeControllerGetEmployeeDetails(
   ...
   * @memberof EmployeeApi
   */
  public employeeControllerGetEmployees(
    requestParameters: EmployeeApiEmployeeControllerGetEmployeesRequest = {},
    options?: AxiosRequestConfig,
  ) {
    return EmployeeApiFp(this.configuration)
      .employeeControllerGetEmployees(
        ...
        requestParameters.employeeNumber,
   ...
   * @memberof EmployeeApi
   */
  public employeeControllerUpdateEmployee(
    requestParameters: EmployeeApiEmployeeControllerUpdateEmployeeRequest,
    options?: AxiosRequestConfig,
  ) {
    return EmployeeApiFp(this.configuration)
      .employeeControllerUpdateEmployee(
